...
public class MyPostDetailActivity extends AppCompatActivity {
    ...
    private Button btn_send,btn_back,btn_rating,btn_update_delete_post;
    ...
    private void initView() {
        ...
        btn_update_delete_post = findViewById(R.id.btn_update_delete_post);
        ...
        LinearLayoutManager manager = new LinearLayoutManager(MyPostDetailActivity.this,RecyclerView.VERTICAL,false);
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(comment.isEmpty()){
                    Toast.makeText(MyPostDetailActivity.this, "Vui lòng nhập bình luận", Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    List<Comment> list = sqLiteHelper.getCommnetByIdPost(item.getId());
                    comment_adapter.setList(list);
                    Toast.makeText(MyPostDetailActivity.this, "Đã thêm bình luận", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btn_rating.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Rating rt_old = sqLiteHelper.findRatings(mAuth.getCurrentUser().getEmail(),item.getId());
                AlertDialog.Builder builder= new AlertDialog.Builder(MyPostDetailActivity.this);
        ...
        btn_update_delete_post.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyPostDetailActivity.this, UpdateAndDeletePostActivity.class);
