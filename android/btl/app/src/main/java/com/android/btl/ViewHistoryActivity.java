...
public class ViewHistoryActivity extends AppCompatActivity implements RViewPostAdapter.ItemListener{
    ...
    private void initView() {
        ...
        sqLiteHelper = new SQLiteHelper(ViewHistoryActivity.this);
        mAuth = FirebaseAuth.getInstance();

        post_adapter= new RViewPostAdapter();
        List<RViewPostItem> list = sqLiteHelper.getRViewPostsByUserViewHistory(mAuth.getCurrentUser().getEmail());
        post_adapter.setList(list);
        LinearLayoutManager manager = new LinearLayoutManager(ViewHistoryActivity.this,RecyclerView.VERTICAL,false);
    ...
    public void onItemClick(View view, int position) {
        ...
        Intent intent = new Intent(ViewHistoryActivity.this, PostDetailActivity.class);
